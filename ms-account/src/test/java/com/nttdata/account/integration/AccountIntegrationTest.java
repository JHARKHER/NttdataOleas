package com.nttdata.account.integration;
...
public class AccountIntegrationTest {
    ...
    void testCreditMovement() {
        movementService.createMovement("123456", new BigDecimal("200"), "CREDIT");

        Optional<Account> updatedAccountOpt = accountRepository.findByAccountNumber("123456");
    ...
    void testDebitMovement() {
        movementService.createMovement("123456", new BigDecimal("500"), "DEBIT");
    ...
    void testDebitMovementInsufficientBalance() {
        RuntimeException exception = assertThrows(RuntimeException.class, () ->
                movementService.createMovement("123456", new BigDecimal("1500"), "DEBIT")
        );
